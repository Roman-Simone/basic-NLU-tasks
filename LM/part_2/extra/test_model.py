...
if __name__ == "__main__":
    ...
    # name_model = "model_21.pt" -> weight_tying 
    # name_model = "model_22.pt" -> Variational_Dropout 
    # name_model = "model_23_auto.pt" -> AvSGD_auto 
    # name_model = "model_23_manual.pt" -> AvSGD_manual
    name_model = "model_23_manual.pt"
