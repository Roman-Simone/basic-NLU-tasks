...
if __name__ == "__main__":
    ...
    final_epoch = 0
    switch_ASGD = False # flag to know if we are in ASGD mode
    window = 3  # non monotonicity window
    list_weights = []
    ...
    for epoch in pbar:
        ...
        if switch_ASGD:
            ...
            # redefine optimizer with the averaged weights
            optimizer = optim.SGD(model.parameters(), lr=config["lr"])
        ...
        if  ppl_dev < best_ppl: # the lower, the better
            ...
            config["lr"] *= 4/10    # Reduce learning rate
